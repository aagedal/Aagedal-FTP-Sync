...
private struct ECDSASignatureHelper {
    ...
    private init(r: ByteBuffer, s: ByteBuffer, pointSize: Int) throws {
        ...
        // These values are attacker-controlled and parsed before authentication. Oversized
        // values would produce a negative offset and write outside this stack allocation.
