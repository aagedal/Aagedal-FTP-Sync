...
/// Provisional FTP-side v2 interchange contract. The companion exporter must
/// implement and verify this contract before production library import is enabled.
...
struct PeopleLibraryPayload: Codable, Equatable, Sendable {
    struct Example: Codable, Equatable, Sendable {
        ...
        init(from decoder: Decoder) throws {
            let c = try PeopleLibraryCoding.object(decoder, required: ["id", "embeddingPath"], optional: ["thumbnailPath"])
