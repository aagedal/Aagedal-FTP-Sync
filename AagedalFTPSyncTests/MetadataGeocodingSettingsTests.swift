...
final class MetadataGeocodingSettingsTests: XCTestCase {
    ...
    func testExplicitOfflineContractAndIndependentOptInsRoundTrip() throws {
        ...
        XCTAssertEqual(MetadataGeocodingSettings.providerVersion, "SwiftMediaMetadata-2.0.0")
        XCTAssertEqual(OfflineMetadataGeocodingProvider.identity.version, "SwiftMediaMetadata-3.0.1")
